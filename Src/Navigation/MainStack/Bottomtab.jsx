    ...
    >
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) =>
            focused ? (
              <Activehome height={RF(30)} width={RF(30)} />
            ) : (
              <InactiveHome height={RF(30)} width={RF(22)} />
            ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) =>
            focused ? (
              <Activefavourite height={RF(30)} width={RF(30)} />
            ) : (
              <InactiveFavorite height={RF(30)} width={RF(20)} />
            ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) =>
            focused ? (
              <InactiveCategories height={RF(30)} width={RF(30)} />
            ) : (
              <InactiveCategories height={RF(30)} width={RF(20)} />
            ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) =>
            focused ? (
              <Activecart height={RF(30)} width={RF(30)} />
            ) : (
              <InactiveCart height={RF(30)} width={RF(20)} />
            ),
        }}
      />
      <Tab.Screen
