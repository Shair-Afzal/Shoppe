        ...
        renderItem={({ item, index }) => (
          <View style={{ ...GST.CENTERCONTAINER, marginTop: RF(10) }}>
            <View style={{ ...GST.ROW, gap: RF(10) }}>
              <CategoriesList
                item={item}
                catimg={{ height: RF(45), width: RF(45), resizemode: 'cover' }}
                style={{ padding: RF(5) }}
                txt
                num
              />
            ...
            <View style={{ justifyContent: 'space-between', height: RF(100) }}>
              ...
              <TouchableOpacity
                style={{
                  backgroundColor: index > 2 ? colors.DarkWhite : colors.blue,
                  padding: RF(7),
                  paddingHorizontal: RF(27),
                  borderRadius: RF(10),
              ...
              >
                <Text
                  style={{
                    ...GST.smallesttxt,
                    color: index > 2 ? colors.blue : colors.DarkWhite,
                  }}
                >
