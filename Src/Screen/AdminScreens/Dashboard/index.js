...
const quickActions = [
    { id: 'qa1', label: 'Manage\nUsers', screen: 'ManageUsers', color: colors.sellerPrimary, bg: colors.sellerLight },
    { id: 'qa2', label: 'Manage\nSellers', screen: 'ManageSellers', color: colors.sellerAccent, bg: '#CFFAFE' },
    { id: 'qa3', label: 'Manage\nOrders', screen: 'ManageOrders', color: colors.sellerSuccess, bg: '#D1FAE5' },
    { id: 'qa4', label: 'Manage\nProducts', screen: 'ManageProducts', color: colors.sellerWarning, bg: '#FEF3C7' },
];

const recentActivity = [
    { id: 'r1', action: 'New seller registered', time: '2 min ago', dot: colors.sellerAccent },
    { id: 'r2', action: 'Order #5821 placed by Ali', time: '8 min ago', dot: colors.sellerSuccess },
    { id: 'r3', action: 'Product flagged for review', time: '15 min ago', dot: colors.sellerWarning },
    { id: 'r4', action: 'User account suspended', time: '1 hr ago', dot: colors.sellerError },
    { id: 'r5', action: 'New user registered', time: '2 hr ago', dot: colors.sellerPrimary },
];
                ...
                <View style={styles.headerContent}>
                    ...
                    <View style={styles.headerButtonsContainer}>
                        ...
                        <TouchableOpacity 
                            ...
                            activeOpacity={0.7}
                            onPress={() => navigation.navigate('AdminEditProfile', { adminData: { name: 'Super Admin', email: 'admin@shoppe.com', phone: '+92-300-1234567', store: 'Shoppe Store', image: 'https://via.placeholder.com/100', joinDate: 'Jan 2024', totalChats: 156, responseTime: '2 mins avg', rating: 4.8 } })}
                        >
            ...
            >
                    ...
                    {statsData.map(item => {
                        ...
                        return (
                            <View key={item.id} style={[styles.statCard, { borderLeftColor: item.color }]}>
                                ...
                                <View style={[styles.changeBadge, { backgroundColor: item.positive ? '#D1FAE5' : '#FEE2E2' }]}>
                                    <Text style={[styles.changeTxt, { color: item.positive ? colors.sellerSuccess : colors.sellerError }]}>
                ...
                <View style={styles.actionsRow}>
                    {quickActions.map(qa => (
                        <TouchableOpacity
                            key={qa.id}
                            style={[styles.actionBtn, { backgroundColor: qa.bg, borderColor: qa.color }]}
                            activeOpacity={0.75}
                            onPress={() => navigation.navigate(qa.screen)}
                        >
                            <View style={[styles.actionDot, { backgroundColor: qa.color }]} />
                            <Text style={[styles.actionLabel, { color: qa.color }]}>{qa.label}</Text>
                        </TouchableOpacity>
                    ))}
                </View>
                ...
                <View style={styles.activityCard}>
                    {recentActivity.map((item, index) => (
                        <View key={item.id}>
                            ...
                            {index < recentActivity.length - 1 && <View style={styles.activitySep} />}
                        </View>
                    ))}
                </View>
